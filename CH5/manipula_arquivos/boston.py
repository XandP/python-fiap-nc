with open('economic-indicators.csv', 'r') as boston:
    ...
    print('O total de voos é: ' + str(total_voos))
    print('O mês/ano de maior movimento no aeroporto foi: ' +
          str(mes) + '/' + str(ano))
    print('O total de passageiros do ano ' + str(ano_usuario) +
          ' foi de ' + str(int(total_passageiros)))
    print("O mês do ano " + str(ano_usuario) +
          ' com maior média para diária de hotel foi ' + str(mes_maior_diaria))
